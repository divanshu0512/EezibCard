...
import lanyard from "./assets/eezib1.jpeg";
import './Landyard.css';
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const onPointerDown = (e) => {
    ...
    setHovered(true);
    setDragged(true);
    const pointer = e.point || new THREE.Vector3();
    const pos = card.current?.translation() || new THREE.Vector3();
    setOffset(pointer.clone().sub(pos));
  };
